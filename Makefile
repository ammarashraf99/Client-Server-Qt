...
DISTDIR = /home/ammar/programming/Client-Server-Qt/.tmp/project1.0.0
SUBTARGETS    =  \
		sub-Server \
		sub-Client
...
sub-Server-qmake_all:  FORCE
	...
	cd Server/ && $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro
	cd Server/ && $(MAKE) -f Makefile qmake_all
sub-Server: FORCE
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -f Makefile
sub-Server-make_first: FORCE
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -f Makefile 
sub-Server-all: FORCE
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -f Makefile all
sub-Server-clean: FORCE
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -f Makefile clean
sub-Server-distclean: FORCE
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -f Makefile distclean
sub-Server-install_subtargets: FORCE
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -f Makefile install
sub-Server-uninstall_subtargets: FORCE
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -f Makefile uninstall
sub-Client-qmake_all:  FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro
	cd Client/ && $(MAKE) -f Makefile qmake_all
sub-Client: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -f Makefile
sub-Client-make_first: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -f Makefile 
sub-Client-all: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -f Makefile all
sub-Client-clean: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -f Makefile clean
sub-Client-distclean: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -f Makefile distclean
sub-Client-install_subtargets: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -f Makefile install
sub-Client-uninstall_subtargets: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -f Makefile uninstall
...
sub-Server-check:
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -f Makefile check
sub-Client-check:
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -f Makefile check
check: sub-Server-check sub-Client-check

sub-Server-benchmark:
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -f Makefile benchmark
sub-Client-benchmark:
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -f Makefile benchmark
...
sub-Server-distdir: FORCE
	@test -d Server/ || mkdir -p Server/
	cd Server/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Server/Server.pro ) && $(MAKE) -e -f Makefile distdir DISTDIR=$(DISTDIR)/Server

sub-Client-distdir: FORCE
	@test -d Client/ || mkdir -p Client/
	cd Client/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/ammar/programming/Client-Server-Qt/Client/Client.pro ) && $(MAKE) -e -f Makefile distdir DISTDIR=$(DISTDIR)/Client
